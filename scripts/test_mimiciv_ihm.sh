...
if [ $# -ne 2 ]; then
    ...
    echo ""
    echo "Example: $0 ../results/mimiciv/ihm/checkpoints/mimiciv_ihm_lambdarus1_lambdaload0.02/best_multimodal_model_mimiciv.pth 0"
    exit 1
fi
...
python ../src/test_mimiciv_multimodal.py \
    ...
    --test_data_path /home/hhchung/mimic-iv-preprocess/data/ihm/test_ihm-48-cxr-notes-missingInd-standardized_stays.pkl \
